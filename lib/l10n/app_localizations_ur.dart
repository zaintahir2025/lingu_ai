...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get loginTitle => 'لاگ ان کریں';
  ...
  String get tourStayMotivatedDesc =>
      'انعامات کمائیں اور اپنا سلسلہ برقرار رکھیں۔';
  ...
  @override
  String get weeklyXp => 'ہفتہ وار ایکس پی';

  @override
  String get statistics => 'اعداد و شمار';

  @override
  String get totalXp => 'کل ایکس پی';

  @override
  String get levelTitle => 'سطح';
  ...
  @override
  String get minutesSpent => 'صرف کیے گئے منٹ';

  @override
  String levelProgress(int current, int next) {
    return 'سطح $current سے $next';
  }

  @override
  String xpProgress(int current, int total) {
    return '$current / $total ایکس پی';
  }
  ...
  String get receiveRemindersDesktop =>
      'یاد دہانیاں وصول کریں (جب ایپ کھلی ہو)';
  ...
  @override
  String get wordsDueToday => 'آج کے لیے الفاظ';
  ...
  @override
  String get learningTab => 'سیکھ رہا ہوں';
  ...
  @override
  String get ratingAgain => 'دوبارہ';

  @override
  String get ratingHard => 'مشکل';

  @override
  String get ratingGood => 'اچھا';

  @override
  String get ratingEasy => 'آسان';

  @override
  String get ratingSubtextAgain => '< 1 منٹ';
  ...
  String get offlineMessageDefault =>
      'براہ کرم اس خصوصیت کو استعمال کرنے کے لیے انٹرنیٹ سے دوبارہ جڑیں۔';
