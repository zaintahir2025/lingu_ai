...
CREATE TABLE "lesson" (
    ...
    "languageCode" text NOT NULL DEFAULT 'es'::text,
    "unitNumber" bigint NOT NULL DEFAULT 1,
    "grammarNote" text NOT NULL DEFAULT ''::text,
...
CREATE TABLE "user_progress" (
    ...
    "gemsCount" bigint NOT NULL DEFAULT 100,
...
CREATE TABLE "vocab_word" (
    ...
    "partOfSpeech" text NOT NULL DEFAULT 'phrase'::text,
    "ipa" text,
    "cefrLevel" text NOT NULL DEFAULT 'A1'::text,
